...
const clearProductList = () => {
  ...
  console.log('clearProductList', document.getElementsByClassName('items'));
};
...
// Grupo de estudo com Alvaro Raminelli dev Pleno CoinBase
window.onload = () => {
  // function loadCartFromLocalStorage() { 
  //   localStorage.setItem('item', cartList.innerText);
  // }
